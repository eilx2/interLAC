package com.mun.minh_minhh.interlac.Events.Arts.items;
...
public class PaintingsAdapter extends ItemsAdapter<Painting> implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (view.getContext() instanceof ArtMain) {
            ((ArtMain) view.getContext()).openDetails(view, item);
        } else if (view.getContext() instanceof ArtMain) {
